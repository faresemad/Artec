...
from .views import StudentViewSet, McqAnswerViewSet, HandDrawingAnswerViewSet, DigitalDrawingAnswerViewSet, PracticeDrawingAnswerViewSet, StudentResultsViewSet
